...
export default function CartPage() {
  ...
  const pointsValue = pointsToRedeem * 0.01 // Each point is worth $0.01
                ...
                >
                  <div className="flex gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-muted-foreground text-sm mt-1">SKU: {typeof item.id === 'string' ? item.id.substring(0, 8) : `ITEM-${index}`}</p>
                      ...
                      <div className="flex items-center gap-2 mt-2">
                        ...
                        <span className="text-xs text-muted-foreground">
                          ≈ ${(item.points * item.quantity * 0.01).toFixed(2)} value
                        </span>
                      </div>
              ...
              <div className="space-y-4">
                ...
                {subtotal < 100 && (
                  <div className="bg-amber-50 dark:bg-amber-900/20 p-3 rounded-lg text-sm mt-2">
                    <p className="text-amber-800 dark:text-amber-400">Add <strong>${(100 - subtotal).toFixed(2)}</strong> more to qualify for free shipping</p>
                  ...
                  <>
                    <div className="border-t border-slate-200 dark:border-slate-700 pt-4">
                      ...
                      <div className="flex justify-between text-sm text-muted-foreground">
                        ...
                        <span>Value: -${pointsValue.toFixed(2)}</span>
                      </div>
                    </div>
                    ...
                    <div className="bg-blue-50 dark:bg-blue-900/20 p-3 rounded-lg">
                      ...
                      <p className="text-xs text-blue-600 dark:text-blue-400 mt-1">
                        ≈ ${(pointsToEarn * 0.01).toFixed(2)} value
                      </p>
                    </div>
                  </>
                )}
                ...
                <div className="border-t border-slate-200 dark:border-slate-700 pt-4 mt-4">
                  ...
                  <p className="text-xs text-muted-foreground mt-1">Tax calculated at checkout</p>
                </div>
