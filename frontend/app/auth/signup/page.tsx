  ...
  const validateStep = (stepNumber: number): boolean => {
    ...
    if (stepNumber === 1) {
      ...
      if (!formData.phone.trim() || formData.phone === "+216") {
        ...
        newErrors.phone =
            "Phone number must be a valid Tunisian number (e.g., +216 98 123 456)";
      }
    }

    if (stepNumber === 2) {
      if (!formData.address.trim()) newErrors.address = "Address is required";
      if (!formData.gouvernorat) newErrors.gouvernorat = "Gouvernorat is required";
        ...
        <div className="z-10 w-full max-w-md">
          ...
          >
            ...
            <p className="text-sm text-muted-foreground">
              Join our universe of technology
            </p>
          </motion.div>
